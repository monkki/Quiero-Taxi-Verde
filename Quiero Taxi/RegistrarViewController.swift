...
class RegistrarViewController: UIViewController, UITextFieldDelegate, EMCCountryDelegate {
    ...
    @IBAction func aceptarBoton(sender: AnyObject) {
        ...
        if(nombre == "" || apellido == "" || celular == "" || correo == "" || contraseña == "" || codigoPais == "" ){
    ...
    */
    ...
    func registrarUsuario(){
        ...
        let urlObj = Urls();
        let urlString = urlObj.getUrlRegistro(nombre, apellidos: apellido, celular: celular, constraseña: contraseña, correo: correo, codigo_pais: codigoPais)
